...
-callback init(Args :: any()) ->
  {ok, State :: any()} | {ok, State :: any(), Extra :: any()} | {stop, Reason :: any()}.
...
-callback code_change(_OldVsn :: any(), State :: any(), Extra :: any()) -> {ok, State :: any()}.

-callback on_connect(State :: any()) -> {ok, State :: any()} | {stop, Reason :: any()}.

-callback on_connect_error(Reason :: any(), State :: any()) ->
  {ok, State :: any()} | {stop, Reason :: any()}.

-callback on_disconnect(State :: any()) -> {ok, State :: any()} | {stop, Reason :: any()}.
